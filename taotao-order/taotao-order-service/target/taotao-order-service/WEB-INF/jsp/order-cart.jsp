...
<form id="orderForm" class="hide" action="/create.html" method="post">
		...
		<c:forEach items="${carts}" var="cart" varStatus="status">
			...
			<input type="hidden" name="orderItems[${status.index}].picPath" value="${cart.itemImg}"/>
		</c:forEach>
		<input type="hidden" name="payment"  value="${totalPrice}"/>
		<input type="hidden" name="orderShipping.receiverName" value="老吕"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="110112113"/>
		<input type="hidden" name="orderShipping.receiverState" value="北京"/>
		<input type="hidden" name="orderShipping.receiverCity" value="北京"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="中南海"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="直接扔门房"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">老吕</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">110***1123</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 中南海</div>
						<div class="adr-m" limit="30">门房老大爷</div>
